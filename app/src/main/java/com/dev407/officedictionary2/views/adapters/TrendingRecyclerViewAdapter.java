...
import com.dev407.officedictionary2.fragments.TrendingFragment.OnTrendingFragmentInteractionListener;
 ...
 * specified {@link OnTrendingFragmentInteractionListener}.
...
public class TrendingRecyclerViewAdapter extends RecyclerView.Adapter<TrendingRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnTrendingFragmentInteractionListener mListener;

    public TrendingRecyclerViewAdapter(List<DummyItem> items, OnTrendingFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
